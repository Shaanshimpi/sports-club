...
if(isset($_POST['submit'])){
	...
	// Escape inputs
	$calorie = pg_escape_string($con, $calorie);
	$height = pg_escape_string($con, $height);
	$weight = pg_escape_string($con, $weight);
	$fat = pg_escape_string($con, $fat);
	$remarks = pg_escape_string($con, $remarks);
