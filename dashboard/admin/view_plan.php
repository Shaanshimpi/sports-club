				...
				<tbody>
					...
					if (pg_num_rows($result) != 0) {
					    while ($row = pg_fetch_assoc($result)) {
					        ...
					        echo '<td><a href="edit_plan.php?id='.htmlspecialchars($row['pid']).'"><input type="button" class="a1-btn a1-blue" id="boxxe" style="width:100%" value="Edit Plan" ></a><form action="del_plan.php" method="post" onSubmit="return ConfirmDelete();"><input type="hidden" name="name" value="' . htmlspecialchars($msgid) .'"/><input type="submit" id="button1" value="Delete Plan" class="a1-btn a1-orange"/></form></td></tr>';
