...
if(isset($_POST['submit'])){
  ...
  // Escape inputs
  $usrname = pg_escape_string($con, $_POST['login_id']);
  $fulname = pg_escape_string($con, $_POST['full_name']);
  $session_user = pg_escape_string($con, $_SESSION['full_name']);

  $query="UPDATE admin SET username='$usrname',\"Full_name\"='$fulname' WHERE username='$session_user'";
